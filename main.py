...
if agent_mode in {"openai", "doubao"}:
    from virtual_sales_agent.openai_graph import graph
elif os.getenv("LOCAL_MOCK_MODE", "true").lower() == "true":
    from virtual_sales_agent.local_graph import graph
else:
